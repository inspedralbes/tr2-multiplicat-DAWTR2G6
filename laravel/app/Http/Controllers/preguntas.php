...
class preguntas extends Controller
{
    ...
    {
        $preguntas["preguntas_unidades__categorizadas"]  = preguntasModel::where('categoria_id', $categoriaId)->get();
        return response()->json($preguntas);
    }
    ...
    public function recibir_preguntas_porCategoria($categoriaNombre)
    {
        ...
        if ($categoria) {
            ...
            $preguntas["preguntas_unidades__categorizadas"] = preguntasModel::where('categoria_id', $categoria->id)->get();
            return response()->json($preguntas);
        } else {

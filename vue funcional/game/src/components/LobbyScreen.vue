  ...
  <body>
    ...
    <div class="lobby-container">
      ...
      <div class="lobby-options">
        ...
        <button
          @click="startSinglePlayerMode"
          class="btn"
          :disabled="multiPlayerModeStarted || mode === 'multiPlayer'"
        >
          {{
            multiPlayerModeStarted
              ? "Deshabilitado hasta encontrar partida"
              : "Vs Tu Mismo!"
          }}
        </button>
        <button
          @click="startMultiPlayerMode"
          class="btn"
          :disabled="multiPlayerModeStarted"
        >
